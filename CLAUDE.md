...
| STE-12 | landing page (C13) | **in progress, merged to `main`** — hero, Problem and How it works are live; Product preview, Why Stellar, Closing CTA and Footer are not built |
