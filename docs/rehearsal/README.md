...
| [`2026-09-24T11-11-08Z`](runs/2026-09-24T11-11-08Z/EVIDENCE.md) | 40 | **50 PASS · 0 FAIL · 6 MANUAL** | 61/61 | the first run against the UPGRADED live contracts — EventRegistry v2.5 (STE-46) and RaceRecord v2.6 (STE-60), both in place that morning. Nothing in entries, bibs, quota, claims or results moved; step F.1 (STE-67) is the extra pass over run 3 |
