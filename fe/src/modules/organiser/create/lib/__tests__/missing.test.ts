...
import { EMPTY_RANGE } from "@/modules/organiser/create/components/DateRangeField";
import { EMPTY_PLACE } from "@/modules/organiser/create/components/PlaceFields";
import type { EventDetails } from "@/modules/organiser/create/components/StepDetails";
import { incoherentDates, missingDetails } from "@/modules/organiser/create/lib/missing";
