...
paralel tanpa membaca `lib.rs` siapa pun. Versi folder sekarang: **v2.0.0**.
...
berubah. Jadi `INTERFACE.md (v2.0.0)` di sebelah `HASH_AND_TOTP.md (v1.0.1)` itu disengaja: v2
