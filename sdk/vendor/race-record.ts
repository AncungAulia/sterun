...
export const Errors = {
   ...
   */
  108: {message:"ResultForAnotherEvent"},
  /**
 ...
 */
export type ClaimSkipped = {tag: "NotFound", values: void} | {tag: "NotEntered", values: void};
 ...
 */
export type ResultOutcome = {tag: "Timed", values: readonly [u32]} | {tag: "Untimed", values: void} | {tag: "Dnf", values: void};
...
export interface Client {
  ...
  /**
   * Construct and simulate a record_results transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Records many results for one event in one call. Organiser only. Atomic:
   * any invalid row reverts the whole batch.
   */
  record_results: ({event_id, results}: {event_id: u32, results: Array<ResultEntry>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
  ...
  /**
   * Construct and simulate a claim_racepack_many transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  claim_racepack_many: ({token_ids, operator}: {token_ids: Array<u32>, operator: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<SkippedClaim>>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "AAAAAQAAADlPbmUgcm93IG9mIGEgW2BSYWNlUmVjb3JkOjpyZWNvcmRfcmVzdWx0c2BdIGJhdGNoICh2Mi42KS4AAAAAAAAAAAAAC1Jlc3VsdEVudHJ5AAAAAAIAAAAAAAAAB291dGNvbWUAAAAH0AAAAA1SZXN1bHRPdXRjb21lAAAAAAAAAAAAAAh0b2tlbl9pZAAAAAQ=",
        ...
        "",
        "AAAAAQAAADRPbmUgcmFjZSBwYWNrIGEgYmF0Y2ggZGlkIG5vdCBjbGFpbSwgYW5kIHdoeSAodjIuNykuAAAAAAAAAAxTa2lwcGVkQ2xhaW0AAAACAAAAAAAAAAZyZWFzb24AAAAAB9AAAAAMQ2xhaW1Ta2lwcGVkAAAAAAAAAAh0b2tlbl9pZAAAAAQ=",
        ...
        "",
        ...
        "",
        ...
        "",
  ...
  public readonly fromJSON = {
    name: this.txFromJSON<string>,
        ...
        record_results: this.txFromJSON<Result<void>>,
        extend_record_ttl: this.txFromJSON<Result<void>>,
        claim_racepack_many: this.txFromJSON<Result<Array<SkippedClaim>>>,
