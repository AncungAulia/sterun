...
import { NotAllowedScreen } from "@/modules/organiser/shared/components/NotAllowed";
import { useEventRun } from "@/modules/organiser/create/hooks/useEventRun";
import { useExistingEventNames } from "@/modules/organiser/create/hooks/useExistingEventNames";
import { useCanCreateEvents } from "@/modules/organiser/shared/hooks/useOrganiser";
import { useWallet } from "@/hooks/useWallet";
import { buildEventDocument, documentHash } from "@/modules/organiser/create/lib/event-document";
...
} from "./components/StepCategoryPlan";
import { findNameClash } from "@/modules/organiser/create/lib/event-names";
...
import {
  ...
  duplicateAddOnCode,
  type PlannedAddOn,
} from "./components/StepAddOns";
import { StepDone } from "./components/StepDone";
import { StepTerms } from "./components/StepTerms";
import { StepDetails, EMPTY_DETAILS, type EventDetails } from "./components/StepDetails";
import { StepReview } from "./components/StepReview";
import { focusField, type Missing } from "@/utils/missing-field";

import { incoherentDates, missingDetails } from "./lib/missing";
