...
import { addSusdTrustline, readSusdBalance, requestTestSusd, type FaucetResult } from "@/lib/wallet/susd";
...
export function GetTestSusd({
  ...
  async function getTestSusd() {
    ...
    try {
       ...
       */
      const { signMessage, signTransaction } = await import("@/lib/wallet/kit");
