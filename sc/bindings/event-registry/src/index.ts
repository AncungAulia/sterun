 ...
 */
export type DataKey = {tag: "Admin", values: void} | {tag: "RaceRecordAddr", values: void} | {tag: "EventCount", values: void} | {tag: "Event", values: readonly [u32]} | {tag: "Category", values: readonly [u32, u32]} | {tag: "CategoryCount", values: readonly [u32]} | {tag: "Scanner", values: readonly [u32, string]} | {tag: "AddOn", values: readonly [u32, u32]} | {tag: "AddOnCount", values: readonly [u32]} | {tag: "Organiser", values: readonly [string]} | {tag: "EventEntryCount", values: readonly [u32]} | {tag: "RegistrationCloses", values: readonly [u32]};
...
export interface Client {
  ...
  /**
   * Construct and simulate a increase_quota transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   * v2.4 the contra
   */
  increase_quota: ({event_id, category_id, new_quota}: {event_id: u32, category_id: u32, new_quota: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
  ...
  /**
   * Construct and simulate a get_registration_closes transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  get_registration_closes: ({event_id}: {event_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Option<u64>>>>

  /**
   * Construct and simulate a set_registration_closes transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   * would reopen nothing, because the da
   */
  set_registration_closes: ({event_id, closes_at}: {event_id: u32, closes_at: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        "" ]),
      options
    )
  }
  public readonly fromJSON = {
    upgrade: this.txFromJSON<Result<void>>,
        ...
        increase_quota: this.txFromJSON<Result<void>>,
        ...
        get_registration_closes: this.txFromJSON<Result<Option<u64>>>,
        set_registration_closes: this.txFromJSON<Result<void>>
  }
}